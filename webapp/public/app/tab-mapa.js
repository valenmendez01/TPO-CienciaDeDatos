function Mapa({ slide = false } = {}) {
  ...
  const body = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, marginBottom: 18, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(Seg, { value: mode, onChange: setMode, options: [{ v: "comunas", label: "Comunas" }, { v: "hotspots", label: "Hotspots DBSCAN" }, { v: "calor", label: "Mapa de calor" }] }), mode === "comunas" && /* @__PURE__ */ React.createElement(Seg, { value: metric, onChange: setMetric, options: [{ v: "tasa", label: "Per c\xE1pita" }, { v: "rate", label: "% Severo" }, { v: "n", label: "Volumen" }] })), /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement("div", { ref: elRef, className: "leaflet-wrap" }), /* @__PURE__ */ React.createElement("div", { className: "map-legend", style: { position: "absolute", bottom: 16, left: 16, zIndex: 500 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, marginBottom: 6, fontSize: 14, letterSpacing: ".08em", textTransform: "uppercase" } }, mode === "comunas" ? metric === "tasa" ? "Tasa /100k hab/a\xF1o" : metric === "rate" ? "% que termina severo" : "Siniestros 2021\u201324" : mode === "hotspots" ? "Severidad del hotspot" : "Densidad de siniestros"), legendItems.map((l, i) => /* @__PURE__ */ React.createElement("div", { key: i }, /* @__PURE__ */ React.createElement("i", { style: { background: l.c } }), l.t)))), /* @__PURE__ */ React.createElement("div", { className: "grid g3", style: { marginTop: 20 } }, /* @__PURE__ */ React.createElement(Card, { title: "Hotspot principal", cap: "DBSCAN \xB7 60 m" }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--ff-serif)", fontSize: 44, fontWeight: 500, color: "var(--severe)", lineHeight: 1 } }, /* @__PURE__ */ React.createElement(CountUp, { value: D.hotspots[0].n })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "var(--mute)", marginTop: 6, lineHeight: 1.4 } }, "siniestros en un acceso \xB7 Gral. Paz, Comuna 12")), /* @__PURE__ */ React.createElement(Card, { title: "Concentraci\xF3n", cap: "29 hotspots" }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--ff-serif)", fontSize: 44, fontWeight: 500, color: "var(--amber)", lineHeight: 1 } }, /* @__PURE__ */ React.createElement(CountUp, { value: 4.6, fmt: (v) => v.toFixed(1).replace(".", ",") }), "%"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "var(--mute)", marginTop: 6 } }, "de todos los siniestros en 29 micro-esquinas \u2014 el ~0,2% de la superficie de CABA")), /* @__PURE__ */ React.createElement(Card, { title: "Severidad entre comunas", cap: "casi pareja" }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--ff-serif)", fontSize: 44, fontWeight: 500, color: "var(--slate)", lineHeight: 1 } }, "1,2\xD7"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "var(--mute)", marginTop: 6 } }, "vs 6\xD7 entre perfiles: la gravedad es un perfil, no un barrio"))));
