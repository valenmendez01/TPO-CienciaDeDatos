function Perfiles({ slide = false } = {}) {
  ...
  if (slide) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "app-embed perfiles-embed" }, /* @__PURE__ */ React.createElement("div", { className: "perfiles-grid" }, P.meta.map((m) => /* @__PURE__ */ React.createElement("div", { key: m.perfil, className: "card pf-card" }, /* @__PURE__ */ React.createElement("div", { className: "pf-label" }, m.label), /* @__PURE__ */ React.createElement("div", { className: "pf-sub" }, m.sub), /* @__PURE__ */ React.createElement("div", { className: "pf-meta" }, "edad ", m.edad, " \xB7 ", nf(m.n), " casos"), /* @__PURE__ */ React.createElement("div", { className: "pf-pct", style: { color: m.color } }, /* @__PURE__ */ React.createElement(CountUp, { value: m.sevRate * 100, fmt: (v) => v.toFixed(1).replace(".", ",") }), /* @__PURE__ */ React.createElement("span", null, "%")), /* @__PURE__ */ React.createElement("div", { className: "pf-sevlab" }, "severo"), /* @__PURE__ */ React.createElement("div", { className: "pf-bar" }, /* @__PURE__ */ React.createElement("div", { className: "pf-fill", style: { width: m.sevRate / maxSev * 100 + "%", background: m.color } }), /* @__PURE__ */ React.createElement("div", { className: "pf-base", style: { left: base / maxSev * 100 + "%" } }))))), /* @__PURE__ */ React.createElement("div", { className: "pf-spread" }, /* @__PURE__ */ React.createElement("div", { className: "pf-stat" }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--severe)" } }, /* @__PURE__ */ React.createElement(CountUp, { value: mult, fmt: (v) => Math.round(v) }), "\xD7"), /* @__PURE__ */ React.createElement("label", null, "entre perfiles")), /* @__PURE__ */ React.createElement("div", { className: "pf-stat" }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--slate)" } }, "1,2\xD7"), /* @__PURE__ */ React.createElement("label", null, "entre zonas geogr\xE1ficas")), /* @__PURE__ */ React.createElement("p", { className: "pf-msg" }, "El perfil m\xE1s grave (", /* @__PURE__ */ React.createElement("strong", null, fp(sevMax * 100), "%"), ") es ", /* @__PURE__ */ React.createElement("strong", null, Math.round(mult), " veces"), " m\xE1s severo que el m\xE1s leve (", /* @__PURE__ */ React.createElement("strong", null, fp(sevMin * 100), "%"), "); entre barrios la gravedad es casi pareja. La l\xEDnea marca la base global de ", /* @__PURE__ */ React.createElement("strong", null, pct(base, 1)), ": el ", /* @__PURE__ */ React.createElement("em", null, "qui\xE9n"), " manda sobre el ", /* @__PURE__ */ React.createElement("em", null, "d\xF3nde"), ".")));
  }
