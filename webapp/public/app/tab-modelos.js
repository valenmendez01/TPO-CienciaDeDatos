function Modelos() {
  ...
  const ops = {
    "\xC1rbol d=4": { recall: 0.92, prec: 0.11 },
    "Reg. Log\xEDstica": { recall: 0.75, prec: 0.14 },
    "Random Forest": { recall: 0.7, prec: 0.16 },
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "view wide" }, /* @__PURE__ */ React.createElement(
    PageHead,
    {
      num: "06",
      kicker: "Modelos",
      title: "Cuatro modelos, un mismo protocolo, un <em>ganador</em>",
