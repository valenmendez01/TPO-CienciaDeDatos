function Modelos() {
  ...
  const ops = {
    "\xC1rbol d=4": { recall: 0.93, prec: 0.096 },
    "\xC1rbol d=7": { recall: 0.8, prec: 0.121 },
    "Reg. Log\xEDstica": { recall: 0.75, prec: 0.137 },
    "Random Forest": { recall: 0.71, prec: 0.156 },
    "RF + zona k-means": { recall: 0.7, prec: 0.16 }
  };
