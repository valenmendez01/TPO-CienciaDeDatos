function Modelos() {
  ...
  const ops = {
    "\xC1rbol d=4": { recall: 0.92, prec: 0.094 },
    "\xC1rbol d=7": { recall: 0.83, prec: 0.11 },
    "Reg. Log\xEDstica": { recall: 0.75, prec: 0.136 },
